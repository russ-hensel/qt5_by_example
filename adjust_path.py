...
sys.path.insert( 1, "/mnt/WIN_D/Russ/0000/python00/python3/_projects/rshlib/test/" )
...
sys.path.insert( 1, "/mnt/WIN_D/Russ/0000/python00/python3/_projects/stuffdb/" )
sys.path.insert( 1, "/mnt/WIN_D/Russ/0000/python00/python3/_projects/qt_by_example/ex_qt_more/" )
...
sys.path.insert( 1, "/mnt/WIN_D/Russ/0000/python00/python3/_projects/wat"  )
sys.path.insert( 1, "/mnt/WIN_D/Russ/0000/python00/python3/_projects/rshlib"  )

#rom    app_global import AppGlobal

print( "your path has been adjusted fron examples for qt on theProf Mint" )
