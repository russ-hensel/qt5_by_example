...
MAX_REPR_LEN    = iaq.MAX_REPR_LEN
MAX_STR_LEN     = iaq.MAX_STR_LEN
MAX_LIST_ITEMS  = iaq.MAX_LIST_ITEMS
...
# -----------------------------------
class InfoAboutList( iaq.InfoAboutBase  ):
    """
    What it says
...
# -----------------------------------
class InfoAboutDict( iaq.InfoAboutBase  ):
...
# -----------------------------------
class InfoAboutString( iaq.InfoAboutBase  ):
...
# -----------------------------------
class InfoAboutDatetime( iaq.InfoAboutBase  ):
...
# -----------------------------------
class InfoAboutTimeDelta( iaq.InfoAboutBase  ):
...
# -----------------------------------
class InfoAboutxxx( iaq.InfoAboutBase  ):
